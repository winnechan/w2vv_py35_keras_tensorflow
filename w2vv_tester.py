...
def process(option, trainCollection, valCollection, testCollection):
    ...
    print(option.model_path)
    #print(trainCollection)
    # result file info
    ...
    print(model_path_1)
    print(model_path_2)
    model_path = os.path.join(model_path_1, testCollection, 'results', model_path_2)
    ...
    print("Image to text: recall@1 %.1f, recall@5 %.1f, recall@10 %.1f, %.1f, %.1f" % (r1i, r5i, r10i, medri, meanri))
    fout_perf = open(os.path.join(output_dir, 'perf.txt'), 'w')
    fout_perf.write("Image to text: recall@1 %.1f, recall@5 %.1f, recall@10 %.1f, %.1f, %.1f\n" % (r1i, r5i, r10i, medri, meanri))
    fout_perf.close()
